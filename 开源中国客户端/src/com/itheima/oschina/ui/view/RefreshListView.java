...
public class RefreshListView extends ListView implements OnScrollListener{
	...
	private final static String SHOW_MORE ="加载更多...";
	private final static String SHOW_MORE_ERROR ="加载更多失败或未找到新数据...";
	 ...
	 * 未加载到新数据
	 */
	public void onRefreshEndComplete() {
		tv_show.setText(SHOW_MORE_ERROR);
	}
